...
function UserManagement() {
  ...
  const { mutate: deleteUser, isPending, isSuccess, isError } = useDeleteMutation();
  ...
  // Function to get role name based on the role value
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-250 p-32">
      <div className="p-6 text-white flex items-center">
        ...
        <div className="ps-12">
          <h1 className="text-24 font-bold">Gerenciamento de Usuários</h1>
      ...
      <div className="w-full p-12 shadow-lg rounded-8 mt-32 bg-gray-300 text-white">
        <table className="w-full border border-gray-300">
          <thead className="bg-gray-100">
            <tr>
              <th className="py-3 px-4 border-b bg-gray-400 text-start">Nome</th>
              <th className="py-3 px-4 border-b bg-gray-400 text-start">Username</th>
              <th className="py-3 px-4 border-b bg-gray-400 text-start">Email</th>
              <th className="py-3 px-4 border-b bg-gray-400 text-start">Permissão</th>
              <th className="py-3 px-4 border-b bg-gray-400 text-start">Ações</th>
            </tr>
          </thead>
          <tbody>
            {users?.map((user) => (
